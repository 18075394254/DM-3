 ...
 */
public class MySeverityGaiView extends View {
    ...
    //将压力数据集合和位移数据集合传递进来
    public MySeverityGaiView(Context context, ArrayList<Float> forceData,ArrayList<Float> disData) {
        super(context);
    ...
    * */
    public MySeverityGaiView(Context context, AttributeSet attrs) {
        super(context, attrs);

    }
    //可选添加，不会被系统自动调用。除非在其余的构造方法中通过this（）方式调用此构造方法，才会运行
    public MySeverityGaiView(Context context, AttributeSet attrs, int defStyleAttr) {

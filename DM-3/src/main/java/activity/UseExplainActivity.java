 ...
 */
public class UseExplainActivity extends BaseActivity implements OnPageChangeListener, OnLoadCompleteListener,
        OnPageErrorListener {
    private static final String TAG = UseExplainActivity.class.getSimpleName();
